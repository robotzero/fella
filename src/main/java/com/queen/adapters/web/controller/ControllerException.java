...
public class ControllerException {
	...
	public ResponseEntity<ExceptionDTO> handleMonitorTypeException(final Exception exception) {
	...
	public ResponseEntity<ExceptionDTO> handleGenericException(final Exception exception) {
	...
	public ResponseEntity<ExceptionDTO> handleInvalidUserException(final Exception exception) {
		logger.error(exception);
		return new ResponseEntity<>(
	...
	public ResponseEntity<ExceptionDTO> handleDuplicateKeyException(final Exception exception) {
		logger.error(exception);
		return new ResponseEntity<>(
	...
	public ResponseEntity<ExceptionDTO> handleValidationException(final Exception exception) {
		logger.debug(exception);
		logger.error(exception.getMessage());
		return new ResponseEntity<>(
