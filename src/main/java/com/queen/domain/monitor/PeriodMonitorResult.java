...
public sealed interface PeriodMonitorResult {
	record PeriodMonitor(String id, Date startDate, Date endDate, String notes, MonitorTypeResult monitorTypeResult, List<Period> periods) implements PeriodMonitorResult {}
